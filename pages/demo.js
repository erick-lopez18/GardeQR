                ...
                <div className="flex flex-col py-24 place-items-center justify-center">
                    ...
                    <div>
                        <h1>Página de inicio</h1>
                            <Link href="/valid"> <button class="button-38" role="button">Ir a la página valid</button> </Link>
                            <p className="garde-column"></p>
                            <Link href="/warning"> <button class="button-38" role="button">Ir a la página warning</button> </Link>
                     </div>
